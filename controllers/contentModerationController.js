...
const reportContent = async (req, res) => {
  try {
    ...
    res.json({
      success: true,
      message: 'Conteúdo reportado para moderação com sucesso',
      data: result.data
    });
...
const moderateContent = async (req, res) => {
  try {
    ...
    res.json({
      success: true,
      message: 'Conteúdo moderado com sucesso',
      data: result.data
    });
...
const getModerationReports = async (req, res) => {
  try {
    ...
    const result = await ContentModerationService.getModerationReports(filters);
...
const getModerationReport = async (req, res) => {
  try {
    ...
    const result = await ContentModerationService.getModerationReport(reportId);
...
const getModerationStats = async (req, res) => {
  try {
    ...
    const result = await ContentModerationService.getModerationStats(filters);
...
const getReportsByStatus = async (req, res) => {
  try {
    ...
    const result = await ContentModerationService.getReportsByStatus(
      status,
      filters
    );
...
const getReportsByContentType = async (req, res) => {
  try {
    ...
    const result = await ContentModerationService.getReportsByContentType(
      contentType,
      filters
    );
...
const getReportsByReason = async (req, res) => {
  try {
    ...
    const result = await ContentModerationService.getReportsByReason(
      reason,
      filters
    );
...
const getPendingReports = async (req, res) => {
  try {
    ...
    const result = await ContentModerationService.getPendingReports(filters);
...
const getReportsByUser = async (req, res) => {
  try {
    ...
    console.error('Erro ao obter relatórios por usuário:', error);
    res.status(500).json({
      success: false,
      message: 'Erro interno do servidor',
      error: process.env.NODE_ENV === 'development' ? error.message : undefined
...
const getMyReports = async (req, res) => {
  try {
    ...
    console.error('Erro ao obter meus relatórios:', error);
    res.status(500).json({
      success: false,
      message: 'Erro interno do servidor',
      error: process.env.NODE_ENV === 'development' ? error.message : undefined
